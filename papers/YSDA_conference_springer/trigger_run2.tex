...
%                                     \toctitle is used
%
\author{Tatiana Likhomanenko\inst{1, 2, 3} \email{tatiana.likhomanenko@cern.ch} \and Michael Williams\inst{4} \email{mwill@mit.edu}}

%\and Philip Ilten\inst{5} \and Egor Khairullin\inst{2, 4} \and Alex Rogozhnikov\inst{1, 2} \and Andrey Ustyuzhanin\inst{1, 2, 3, 4}
...
\institute{ National Research University Higher School of Economics (HSE), RU
\and
Yandex School of Data Analysis (YSDA), RU
\and 
...
\begin{figure}
	\begin{center}
    	...
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/roc_all_top} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
...
\begin{figure}
	\begin{center}
    	...
    	\end{subfigure} %forest_sel_top_train} 
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/roc_all_top_partial} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
...
\begin{figure}
	\begin{center}
    	...
    	\end{subfigure} %forest_sel_top_train} 
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/roc_all_top_forest} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
...
\begin{figure}
	\begin{center}
    	...
    	\end{subfigure} %forest_sel_top_train} 
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/roc_all_top_xgb} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
...
\begin{figure}
	\begin{center}
    	...
    	\end{subfigure} %forest_sel_top_train} 
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/roc_all} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
...
\begin{figure}
	\begin{center}
    	...
    	\end{subfigure} %forest_sel_top_train} 
    	\begin{subfigure}[b]{0.45\textwidth}
    		\includegraphics[width=\textwidth]{../../img/rocs_fast_all} \caption{} %forest_sel_top}
    	\end{subfigure}
    \end{center}
